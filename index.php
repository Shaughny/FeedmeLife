...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="html/aisles/vegeAisle.php">Fruits & Veges</a>
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                   <a href="html/Interface/cart.php" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="17"
    ...
    <div class="big-banner" style="height: 100em; padding-top: 150px; ">
        <div class="grid-container">
            <a href="html/aisles/vegeAisle.php">
                <div class="grid-item item-1">
                    <p><span class="item-name">Fruits & Veges</span></p>
                </div>
            </a>
            <a href="html/aisles/dairyAisle.php">
                <div class="grid-item item-2">
                    <p><span class="item-name">Dairy & Eggs</span></p>
                </div>
            </a>
            <a href="html/aisles/meatAisle.php">
                <div class="grid-item item-3">
                    <p><span class="item-name">Meat & Poultry</span></p>
                </div>
            </a>
            <a href="html/aisles/pantryAisle.php">
                <div class="grid-item item-4">
                    <p><span class="item-name">Pantry</span></p>
                </div>
            </a>
            <a href="html/aisles/snacksAisle.php">
                <div class="grid-item item-5">
                    <p><span class="item-name">Snacks</span></p>
                </div>
            </a>
            <a href="html/aisles/mealsAisle.php">
                <div class="grid-item item-6">
                    <p><span class="item-name">Prepared meals</span></p>
                </div>
            </a>
            <a href="html/aisles/frozenAisle.php">
                <div class="grid-item item-7">
                    <p><span class="item-name">Frozen</span></p>
                </div>
            </a>
            <a href="html/aisles/bakeryAisle.php">
                <div class="grid-item item-8">
                    <p><span class="item-name">Bakery</span></p>
                </div>
            </a>
            <a href="html/aisles/beverageAisle.php">
                <div class="grid-item item-9">
                    <p><span class="item-name">Beverages</span></p>
                </div>
            </a>
        </div>
    </div>
