...
<body>
    ...
    <div class="big-banner">
        <div class="signUp-container">
            ...
            <form method="post" action ="" style="padding: 40px;" id="signUp_box">
            ...
            ?>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" class="form-control"  name="firstName" size = 20>
                        <label for="zip">Zip Code:</label>
                        <input type="text" class="form-control"  name="zip" size =6>
                    </div>
                    <div class="col">
                        <label for="lastName">Last Name:</label>
                        <input type="text" class="form-control"  name="lastName" size = 20>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="email" class="form-control"  name="emailConfirm" size = 40>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="password" class="form-control"  name="passwordConfirm" size = 20>
                    </div>
                </div>
                <button type="submit" class="btn btn-outline-succes" name = "login">Create Account</button>
                <div><a href="loginPage.php" class="btn btn-outline-succes"
                            style="color: grey; "><u>Already have an account? Sign in</u></a></div>
            </form>
        </div>
    </div>
    <!--End of landing page-->
