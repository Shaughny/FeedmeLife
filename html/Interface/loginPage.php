<?php
    ...
    if(isset($_POST['login'])){
        ...
        foreach($xml->user as $user){
            if((((string)$user->email) == $email) && (((string)$user->password) == $password)){
                ...
                setcookie("firstName", $user->firstName, time()+3600); //cookie expires in 3600 seconds (1 hour)
                setcookie("lastName", $user->lastName, time()+3600);   //for some reason the backstore would not let session exist so this is the workaround
    ...
    if(isset($_GET['logOut'])&&$_GET['logOut']==true){
        setcookie("firstName", $_COOKIE['firstName'], time()-3600); //make the cookies expire in the past so that the browser deletes them immediately
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                     <a href="../../html/Interface/cart.php" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg"
                             width="17" height="17" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
                             <path
            ...
            <div class="row">
                <div class="col-sm-6" style="background-color: floralwhite;">
                    <div class="text-center">
                        <img class="img-fluid" src='../../images/dumb_temp_logo.png' alt="logo"
                            style="max-width:10%; padding: 5px;">
                    </div>
                    <div id="login_box" style="padding: 15px;">
                        ...
                        <form method="post" action ="" style="padding: 25px;">
                            ...
                            <div><button type="submit" class="btn btn-outline-succes" style="color: grey;"><u>Forgot
                                        your password?</u></button></div>
                        </form>
                        <div style="padding-left: 25px;">
                            <?php
                            if($error){
                                echo '<p style = "color: red">Invalid email and/or password</p>';
                            }
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <a href="signUpPage.php"><button type="submit" class="btn btn-outline-succes"
                                style="color: grey; "><u>Sign up</u></button></a>
                    </div>
                </div>
                <div class="col-sm-6 bg-dark">
                    <h2 class="text-center" style="padding: 20px;">Here at Feed me Life we believe that everyone sould
                        have access to quality, organic food.
                        <br>Our team is engaged to provide the best service possible.
                        <br><br>Our fresh, hand-picked vegetables and fruits will make you question why you ever went to
