            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item menuItemActive" href="mealsAisle.php">Prepared Meals</a>
    ...
    <div class="big-banner" style="height: 100em; padding-top:150px;">
        <div class="aisleMenu float-container">
            <div class="float-child" id="leftMenu">
                <table>
                    <ul style="list-style-type:none">
                        ...
                        <li class="menuItem menuItemActive"><a href="mealsAisle.php">Prepared Meals</a></li>
            ...
            <div class="menu float-child" id="rightMenu">
                <h1 id="aisleTitle">Prepared Meals</h1>
                <div class="grid-container">
                    <a href="../ProductDescription/turkeysandwich.php">
                    <p><span class="item-name">Turkey sandwich</span></p>
                        <div class="grid-item" style="background-image: url('../../images/turkey.jpg');">
                            
                        </div>
                    </a>
                    <a href="../ProductDescription/hamsandwich.php">
                    <p><span class="item-name">Ham sandwich</span></p>
                        <div class="grid-item" style="background-image: url('../../images/hamsand.jpg');">
                            
                        </div>
                    </a>
                    <a href="../ProductDescription/meatballsub.php">
                    <p><span class="item-name">Meatball sub</span></p>
                        <div class="grid-item" style="background-image: url('../../images/meatball.png');">
                            
                        </div>
                    </a>
                    <a href="../ProductDescription/hummus.php">
                    <p><span class="item-name">Hummus</span></p>
                        <div class="grid-item" style="background-image: url('../../images/hummus.jpg');">
                            
                        </div>
                    </a>
                    <a href="../ProductDescription/tzatziki.php">
                    <p><span class="item-name">Tzatziki</span></p>
                        <div class="grid-item" style="background-image: url('../../images/tzatziki.jpg');">
                            
                        </div>
                    </a>
                    <a href="../ProductDescription/pesto.php">
                    <p><span class="item-name">Pesto</span></p>
                        <div class="grid-item" style="background-image: url('../../images/pesto.jpg');">
                            
                        </div>
                    </a>
                    <a href="../ProductDescription/tomatosoup.php">
                    <p><span class="item-name">Tomato Soup</span></p>
                        <div class="grid-item" style="background-image: url('../../images/tomatosoup.jpg');">
                            
                        </div>
                    </a>
                    <a href="../ProductDescription/salads.php">
                    <p><span class="item-name">Salads</span></p>
                        <div class="grid-item" style="background-image: url('../../images/salad.jpg');">
