            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item menuItemActive" href="snacksAisle.php">Snacks</a>
        ...
        <div class="aisleMenu float-container">
            <div class="float-child" id="leftMenu">
                <table>
                    <ul style="list-style-type:none">
                        ...
                        <li class="menuItem menuItemActive"><a href="snacksAisle.php">Snacks</a></li>
            ...
            <div class="menu float-child" id="rightMenu">
                <div class="grid-container">
                    <a href="../ProductDescription/chips.php">
                     <p><span class="item-name">Salted Chips</span></p>
                        <div class="grid-item" style="background-image: url('../../images/chips.jpg');">
                           
                        </div>
                    </a>
                    <a href="../ProductDescription/crackers.php">
                    <p><span class="item-name">Crackers</span></p>
                        <div class="grid-item" style="background-image: url('../../images/crackers.jpg');">
                            
                        </div>
                    </a>
                    <a href="../ProductDescription/peanuts.php">
                    <p><span class="item-name">Peanuts</span></p>
                        <div class="grid-item" style="background-image: url('../../images/peanuts.jpg');">
                            
                        </div>
                    </a>
                    <a href="../ProductDescription/marsbar.php">
                    <p><span class="item-name">Mars Bar</span></p>
                        <div class="grid-item" style="background-image: url('../../images/mars_bar.jpg');">
                            
                        </div>
                    </a>
                    <a href="../ProductDescription/reecescup.php">
                    <p><span class="item-name">Reeses Cups</span></p>
                        <div class="grid-item" style="background-image: url('../../images/reeces.jpg');">
                            
                        </div>
                    </a>
                    <a href="../ProductDescription/pudding.php">
                    <p><span class="item-name">Vanilla Pudding</span></p>
                        <div class="grid-item" style="background-image: url('../../images/vanilla_pudding.jpg');">
                            
                        </div>
                    </a>
                </div>
                <h1 id="aisleTitle">Snacks</h1>
            </div>
        </div>
    </div>
    </div>
