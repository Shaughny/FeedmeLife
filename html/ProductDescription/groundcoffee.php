...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Ground Coffee</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="groundcoffee">
                    <img src="../../images/groundcoffee.jpg">
                </div>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        This is for all our morning people.
                    </div>
