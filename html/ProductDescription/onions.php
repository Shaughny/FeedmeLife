...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Brown Onion</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="onion">
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">300 g</p>
                <p id="product-price">$2.38 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        If these dont make you cry , the prices will.
                    </div>
