...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Vegetable Oil</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="vegoil">
                    <img src="../../images/vegetableoil.jpg">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">600 ml</p>
                <p id="product-price">$10.78 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        This guy is straight out of the mediterranean.
                    </div>
