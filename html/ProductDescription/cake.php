...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Carrot Cake</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="cake">
                    <img src="../../images/carrot_cake.jpg">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">1500 g</p>
                <p id="product-price">$18.99 ea.</p>
