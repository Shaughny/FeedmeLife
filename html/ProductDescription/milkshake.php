...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">3% Cherry Milkshake</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="milkshake" style="text-align: center;">
                    <img src="../../images/milk_shake.jpg" style="width: 50%; height: auto;">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">450 g</p>
                <p id="product-price">$2.78 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        This amazing drink will be bringing eweryone to the yard.
                    </div>
