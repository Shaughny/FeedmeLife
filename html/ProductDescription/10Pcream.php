...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="cream" style="text-align: center;">
                    <img src="../../images/cream.jpg" style="width: 50%; height: auto;">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">1 litre </p>
                <p id="product-price">$2.99 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        The best cream to get your coffee nice and thick.
                    </div>
