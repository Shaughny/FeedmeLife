...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="mussels">
                    <img src="../../images/mussels.jpg">
                </div>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        I see you checking out my mussels
                    </div>
