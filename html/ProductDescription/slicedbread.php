...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Sliced White Bread</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="slicedbread">
                    <img src="../../images/slicedbread.jpeg">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">675 g</p>
                <p id="product-price">$2.50 ea.</p>
