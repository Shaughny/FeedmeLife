...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">3 Cheese Fondue</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="2percentmilk">
                    <img src="../../images/fondue.jpg">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">500 ml </p>
                <p id="product-price">$4.99 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        Embrace your inner bourgoisie with this sophisticated medley fondue mix.
                    </div>
