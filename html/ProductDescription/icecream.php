...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Lemon Ice Cream</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="icecream">
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">1.5 litres </p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        It's ice cream, what else do you want?
                    </div>
