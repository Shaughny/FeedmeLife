...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Whole Chicken</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="wholechicken">
                    <img src="../../images/wholechicken.jpg">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">1 chicken</p>
                <p id="product-price">$18.78 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        What came first, the chicken or the egg? Who cares, eat both!
                    </div>
