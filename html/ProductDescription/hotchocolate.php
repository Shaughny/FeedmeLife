...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Hot Chocolate</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="hotcoco">
                    <img src="../../images/hotcoco.jpg">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">24 pouches</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        Good ol' hot coco for a cold winter day.
                    </div>
