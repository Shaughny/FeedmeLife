...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">White Rice</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="rice">
                    <img src="../../images/whiterice.jpg">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">2000 g</p>
                <p id="product-price">$12.78 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        Only the finest grains for our customers.
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 segment-two">
                        <h2>Links</h2>
                        <ul><a href="html/Interface/loginPage.php" class="nav-link">Sign in</a>
