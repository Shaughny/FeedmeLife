...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Naan Bread</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="naan">
                    <img src="../../images/naan.jpg">
                </div>
                <?php print_r($_SESSION['cart']['naan']['quantity']);  ?>
            </div>
            <div class="col-md-4 text">


                <p id="product-size">500g</p>
                <p id="product-price">$4.78 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        Get your nan and buy some of this amazing naan bread.
                    </div>
