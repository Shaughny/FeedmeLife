...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Vanilla Pudding</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="pudding" style="text-align: center;">
                    <img src="../../images/vanilla_pudding.jpg" style="width:50%; height: auto;">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">250 ml</p>
                <p id="product-price">$1.78 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        Take one , you deserve one of these rich treats.
                    </div>
