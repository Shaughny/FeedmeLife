...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name"> 10' Tortillas</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="tortillas">
                    <img src="../../images/tortillas.jpg">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">6 tortillas</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        Dont forget to buy some cheese and meat for burrito night.
                    </div>
