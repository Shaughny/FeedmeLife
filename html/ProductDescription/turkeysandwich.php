...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Turkey Sandwich</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="turkeysandwich">
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">1 sandwich</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        Don't worry, we made sure the turkey is dead and ready to eat for ya!
                    </div>
