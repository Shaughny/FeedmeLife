...
if(isset($_POST)){
        ...
        if(isset($_POST['quantity'])){
            ...
            updateCart(2,$amount);
            header("Location: ../Interface/cart.php");
            die;
...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="2percentmilk" style="text-align: center;">
                    <img src="../../images/2percent_milk.jpg" style="width: 50%; height: auto;">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">2 litres </p>
                <p id="product-price">$1.99 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        word wordsss lots of words more words . words wordssssss more words word wordsss lots of words
                        more words . words wordssssss more words word wordsss lots of words more words . words
                        wordssssss more words word wordsss lots of words more words . words wordssssss more words
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 segment-four">
                        ...
                        <form action="#">
                            ...
                            <input type="submit" value="Subscribe" id="inp">
                        </form>
                    </div>
                </div>
            </div>
