...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Organic Brown eggs</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="organiceggs">
                    <img src="../../images/organic_eggs.jpg">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">12 eggs </p>
                <p id="product-price">$7.00 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        These eggs were hatched by vegan, free range hens who lived 2771 meters up in the himilayas for
