...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="bananas">
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">2 lbs</p>
                <p id="product-price">$1.30 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        We're all about monkey business with these sweet sweet bananas.
                    </div>
