...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="salad">
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    My heart says chocolate and wine but my jeans say for the love of god eat a salad!
                    </div>
