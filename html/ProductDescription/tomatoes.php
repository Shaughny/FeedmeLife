...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Hothouse Red Tomato</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="tomatoes">
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">200 g</p>
                <p id="product-price">$0.78 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        Tomato Tomatoe , whatever you call them, we got the best of them.
                    </div>
