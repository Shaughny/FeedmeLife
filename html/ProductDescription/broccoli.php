...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="broccoli">
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        Wow so green, such fresh. The best broccoli in town.
                    </div>
