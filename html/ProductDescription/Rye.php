...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        <div class="row name">
            <div class="col-md-4 ">
                <p id="product-name">Rye Bread Loaf</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="rye">
                    <img src="../../images/rye.jfif" style="display: block;margin-left: auto;margin-right: auto;">
                </div>
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">400 g</p>
                <p id="product-price">$3.78 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        Nothing but the best rye for you guys.
                    </div>
