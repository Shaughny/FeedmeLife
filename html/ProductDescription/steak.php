...
<body onload="descSubtotalCalc()">
    ...
    <div class="container product">
        ...
        <div class="row">
            <div class="col-md-4 ">
                <div class="img-container" id="steak">
            ...
            <div class="col-md-4 text">
                ...
                <p id="product-size">1200 g</p>
                <p id="product-price">$25.78 ea.</p>
            ...
            <div class="col-md-4 ">
                <div class="">
                    ...
                    <div id="para" class="collapse col-md-2 description">
                        Slap this bad boy on the grill and all your neighbours will be jealous! Treat yourself king
                    </div>
